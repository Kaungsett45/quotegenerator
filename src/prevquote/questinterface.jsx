      ...
      if (docsnap.exists()) {
        ...
        if (react) {
          ...
          if (!Checkfav.exists()) {
            ...
            setFavcheck((prevData) => prevData.filter((id) => id !== quid));
  ...
  return (
    <>
      ...
      <div className="flex justify-center ">
        <input
          type="text"
          className="w-full text-center p-2 border-2 border-red-200"
        ...
        {search ? (
          result.length > 0 ? (
            result.map((quote, index) => (
              <li
                key={index}
                className="mx-auto my-20 p-3 bg-[#67B26F] rounded-xl text-center  max-w-[560px]"
              >
                <div className="border-2 p-2 bg-white rounded">
                  {quote.qdescription}
                </div>
            ...
            <p className="text-red-500 text-center my-[100px]">
              Search not found
            </p>
          )
        ) : (
